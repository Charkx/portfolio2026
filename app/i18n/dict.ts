...
export const fr = {
  ...
  hud: {
    ...
    tipLock: "Se déconnecter (rejouer l'intro)",
    disconnectTitle: ">> DÉCONNEXION DE LA SESSION",
    disconnectBody: "Te déconnecter ferme l'interface : les sections se démontent et la séquence d'entrée est rejouée depuis le début. Ton exploration en cours est perdue.",
    disconnectConfirm: "Confirmer la déconnexion",
    disconnectCancel: "Rester connecté",
  ...
  calibration: {
    ...
    quality: "> QUALITÉ :", qHigh: "[HAUTE]", qEco: "[ÉCO]", qEcoTip: "Rendu allégé, halo simplifié",
    lang: "> LANGUE :",
...
export const en: Dict = {
  hud: {
    ...
    tipLock: "Disconnect (replay the intro)",
    disconnectTitle: ">> SESSION DISCONNECT",
    disconnectBody: "Disconnecting closes the interface: sections are unmounted and the entry sequence replays from the start. Your current exploration is lost.",
    disconnectConfirm: "Confirm disconnect",
    disconnectCancel: "Stay connected",
  ...
  calibration: {
    ...
    quality: "> QUALITY:", qHigh: "[HIGH]", qEco: "[ECO]", qEcoTip: "Lighter rendering, simplified glow",
    lang: "> LANGUAGE:",
